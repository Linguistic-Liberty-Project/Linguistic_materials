...
def main():
    ...
    for i in range(1, 100):
        url = 'https://censor.net/ru/theme/705/koronavirus_i_karantin/news/page/'
        page_num = i + 1
    ...
    for url in topic_urls:
        ...
        for news in news_sections:
            ...
            for url in url_array:
                ...
                with open('/Users/lidiiamelnyk/Downloads/articles_russian.txt','a', encoding = 'utf-8-sig') as myfile:
                    for row in comments:
